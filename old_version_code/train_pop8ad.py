...
from Models_class_pop8 import MultiTaskNet_T, MultiTaskNet_S, MultiTaskNet_M, MultiTaskNet_L
...
filenames = random.sample(filenames, 4000) # 4000
...
for epoch in range(100):  # 100 epochs, adjust as needed
    ...
    if val_loss < best_val_loss:
        with open("./trained_models/model_pop8_best_L.pth", "wb") as f:
