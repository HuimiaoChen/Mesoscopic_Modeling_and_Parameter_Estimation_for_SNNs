...
from Models_class_pop8 import MultiTaskNet_LLL
...
# Training loop
for epoch in range(150):  # 100 epochs, adjust as needed
    model.train()
    train_loss = 0.0
    ...
    if val_loss < best_val_loss:
        with open("./trained_models/model_pop8_best_LLL.pth", "wb") as f:
...
with open('./trained_models/pop8_LLL_loss_values.json', 'w') as f:
