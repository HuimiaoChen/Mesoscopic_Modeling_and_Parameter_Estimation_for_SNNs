...
from Models_class_pop8 import MultiTaskNet_LL
...
for epoch in range(110):  # 100 epochs, adjust as needed
    ...
    if val_loss < best_val_loss:
        with open("./trained_models/model_pop8_best_LL.pth", "wb") as f:
...
with open('./trained_models/pop8_LL_loss_values.json', 'w') as f:
