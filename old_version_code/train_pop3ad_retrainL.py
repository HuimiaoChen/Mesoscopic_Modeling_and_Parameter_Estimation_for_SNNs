...
from Models_class_pop3 import MultiTaskNet_T, MultiTaskNet_S, MultiTaskNet_M, MultiTaskNet_L, MultiTaskNet_X
...
filenames = random.sample(filenames, 4000) # 4000, 3000
...
for epoch in range(100):  # 100 epochs, adjust as needed
    ...
    if val_loss < best_val_loss:
        with open("./trained_models/model_pop3_best_L_retry.pth", "wb") as f:
...
with open('./trained_models/pop3_L_retry_loss_values.json', 'w') as f:
