...
class MultiTaskNet_L(nn.Module):
    def __init__(self):
        ...
        self.fc_param = nn.Linear(60, 5)
        # self.fc_J_syn = nn.Linear(60, 3*3)
        # self.fc_mu = nn.Linear(60, 3)
        # self.fc_tau_m = nn.Linear(60, 3)
        # self.fc_V_th = nn.Linear(60, 3)
        # self.fc_J_theta = nn.Linear(100, 3)
        # self.fc_tau_theta = nn.Linear(100, 3)

    def forward(self, x):
        x = self.model(x)  # Shape of output x: (batch_size, hidden_size)
        ...
        return param # J_syn, mu, tau_m, V_th #, J_theta, tau_theta


class MultiTaskNet_C(nn.Module):
    def __init__(self):
        super(MultiTaskNet_C, self).__init__()

        # First convolutional layer
        self.conv1 = nn.Conv1d(in_channels=3, out_channels=8, kernel_size=5, stride=1, padding=2)
        # Max-pooling layer
        ...
        # self.fc = nn.Linear(16 * 5, 128)
        self.fc_J_syn = nn.Linear(16 * 5, 3*3)
        self.fc_mu = nn.Linear(16 * 5, 3)
        self.fc_tau_m = nn.Linear(16 * 5, 3)
        self.fc_V_th = nn.Linear(16 * 5, 3)
        # self.fc_J_theta = nn.Linear(100, 3)
        # self.fc_tau_theta = nn.Linear(100, 3)
